...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class EngineerCarControl : MonoBehaviour
    {
        [SerializeField]
        ...
        public EngineerLockFire Engineerlockfire;
        ...
        public void Steer(float steering)
        {
            ...
            if (isGroundedflag && !Engineerlockfire.lockfireflag)
            {
